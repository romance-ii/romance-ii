...
public class Base64Coder {
	 ...
	 * breaks are allowed within the Base64 encoded input data.
	 * 
	 ...
	 * 
	 * @param in A character array containing the Base64 encoded data.
	 * @param iOff Offset of the first character in <code>in</code> to
	 *             be processed.
	 * @param iLenIn Number of characters to process in <code>in</code>
	 *             , starting at <code>iOff</code>.
	 * @return An array containing the decoded data bytes.
	 * @throws IllegalArgumentException If the input is not valid
	 *              Base64 encoded data.
	 */
	public static byte [] decode (final char [] in, final int iOff,
			final int iLenIn) {
		int iLen = iLenIn;
		if ( (iLen % 4) != 0) {
	...
	/**
	 * Decodes a byte array from Base64 format and ignores line
	 * separators, tabs and blanks. CR, LF, Tab and Space characters
	 * are ignored in the input data. This method is compatible with
	...
	/**
	 * Decodes a string from Base64 format. No blanks or line breaks
	 ...
	 * @return A character array containing the Base64 encoded data.
	 */
	public static char [] encode (final byte [] in, final int iOff,
			final int iLen) {
		final int oDataLen = ( (iLen * 4) + 2) / 3; // output length
											// without
		// padding
		final int oLen = ( (iLen + 2) / 3) * 4; // output length
										// including
		// padding
	...
	/**
	 * Encodes a byte array into Base 64 format and breaks the output
	 * into lines of 76 characters. This method is compatible with
	 ...
	 *             starting at <code>iOff</code>.
	 * @param lineLen Line length for the output data. Should be a
	 *             multiple of 4.
	 * @param lineSeparator The line separator to be used to separate
	 *             the output lines.
	 * @return A String containing the Base64 encoded data, broken into
	 *         lines.
	 */
	public static String encodeLines (final byte [] in,
			final int iOff, final int iLen, final int lineLen,
