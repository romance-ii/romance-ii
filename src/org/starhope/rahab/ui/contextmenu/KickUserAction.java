 ...
 *
 */
public class KickUserAction extends RulesAction {

	/**
	 * WRITEME: Document this field. twheys@gmail.com Dec 31, 2009
	 */
	private static final String MONIKER = "Kick";
	 ...
	 */
	public KickUserAction (final String user,
			final MessageCallBack callback) {
		super (KickUserAction.MONIKER, user, callback);
	}
	...
	protected void doCommand (final String option) {
		actionCallBack.sendCommand ("kick", option, userOfInterest);
	}
