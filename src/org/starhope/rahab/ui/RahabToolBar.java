...
public class RahabToolBar extends JToolBar {
     ...
     */
    public RahabToolBar () {
        final ShiftJournalActionListener shiftJournalActionListener =
            new ShiftJournalActionListener ();
        final JButton shiftJournalAction =
            makeNavigationButton (
                    "shift-journal", "Shift Journal Entry",
                    "Shift Journal",
                    shiftJournalActionListener);
        final ReloadUserListsActionListener reloadUserListsActionListener =
            new ReloadUserListsActionListener ();
        final JButton reloadListsAction =
            makeNavigationButton (
                    "reload-lists", "Reload User and Room Lists",
                    "Reload User List",
                    reloadUserListsActionListener);
        final ChangeZoneActionListener changeZoneActionListener =
            new ChangeZoneActionListener ();
        final JButton changeZoneAction =
            makeNavigationButton (
                    "change-zone", "Change Zone", "Change Zone",
                    changeZoneActionListener);
        final ChangeUserActionListener changeUserActionListener =
            new ChangeUserActionListener ();
        final JButton changeUserAction =
            makeNavigationButton (
                    "change-zone", "Log in as a different user",
                    "Change User",
                    changeUserActionListener);
