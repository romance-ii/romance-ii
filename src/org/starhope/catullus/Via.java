...
public class Via <T extends DataRecord> implements RecordLoader <T> {
	...
	throws NotReadyException {
		try {
			AppiusClaudiusCaecus.blather ("Connecting "
					+ vehicle.toString ());
			vehicle.connect ();
			AppiusClaudiusCaecus.blather ("Connected "
					+ vehicle.toString ());
	...
	public T loadRecord (final int id) throws NotFoundException {
		try {
			...
			throw AppiusClaudiusCaecus.fatalBug (
					"Caught a NotReadyException in Via.loadRecord ", e);
		}
	}
	...
	throws NotFoundException {
		try {
			...
			throw AppiusClaudiusCaecus.fatalBug (
					"Caught a NotReadyException in Via.changed ", e);
		}
	}
	...
	public String toString () {
		return "Via <" + klass.getCanonicalName () + "> over "
