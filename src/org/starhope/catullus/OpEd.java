...
public @interface OpEd {
	...
	/**
	 * <p>
	 * Property groups can be assigned headings, and all properties
	 * with the same groupWith heading will appear together under that
	 * heading.
	 * </p>
	 * <p>
	 ...
	 * default, even if the user has sufficient privileges to update
	 * it, usually behind some simple “advanced” expander box or tab.
	 * </p>
	 * <p>
	 * Does not apply to classes.
	 * </p>
