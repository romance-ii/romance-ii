...
public class JavaRMIVehicle implements Vehicle, Remote {
	...
	public void connect () throws NotFoundException,
			...
			NotReadyException, ParameterException, SerialDataException {
	 ...
	 * @see org.starhope.catullus.Vehicle#read(Via,java.lang.Class, int)
	 */
	@Override
	...
	public <T extends DataRecord> T writeSync (final T obj)
		...
		try {
			AppiusClaudiusCaecus.blather ("Calling CVC-RMI:writeSync:"
					+ obj.toString ());
