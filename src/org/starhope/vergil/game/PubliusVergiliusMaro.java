...
public class PubliusVergiliusMaro {
	...
	public static void connectClient (final String hostName,
		...
		try {
			PubliusVergiliusMaro.client.connect (hostName,
					portNumber);
	...
	public static String getImplementorCanonicalName () {
		return PubliusVergiliusMaro.gameImplementor.getClass ()
				.getCanonicalName ();
	}
	...
	public static String getImplementorCopyright () {
		return PubliusVergiliusMaro.gameImplementor
				.getGameCopyright ();
	}
	...
	public static void sendCommand (final String command,
		...
		final com.google.gwt.json.client.JSONObject c = new com.google.gwt.json.client.JSONObject ();
	 ...
	 */
	public void setLoginCredentials (final String login,
