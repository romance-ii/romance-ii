 ...
 * @author brpocock@star-hope.org Bruce-Robert Pocock
 */
public class LoadClient extends TimerTask implements
	...
	public static void main (final String args[]) {
		...
		System.err.println ("There are now approximately 128 simulated users. High water mark success.");
	...
	public void handleEvent (final SmartFauxEvent event) {
		if (event.getName ().equals (SmartFauxEvent.onConnectionLost)) {
			...
			sfs.getRoomList ();
				...
				.equals (SmartFauxEvent.onJoinRoom)) {
			/*
			 * System.out.println (userName +
	...
	public void run () {
		if (talk) {
			...
			final Map <String, SFSVariable> vars = new HashMap <String, SFSVariable> ();
			vars.put ("XPos",
					new SFSVariable ("n", String.valueOf (random
							.nextDouble ())));
			vars.put ("YPos",
					new SFSVariable ("n", String.valueOf (random
							.nextDouble ())));
			...
			vars.put ("YVel",
					new SFSVariable ("n", String.valueOf (random
							.nextDouble ())));
			vars.put ("files_main", new SFSVariable ("s",
					"zapQuad.swf"));
			vars.put ("TootType", new SFSVariable ("s",
					"zapQuad.swf"));
