...
public class Security {
     ...
     */
    public synchronized static void grantCapability (final AbstractUser grantor, final AbstractUser recipient, final SecurityCapability cap) throws PrivilegeRequiredException {
        Security.capabilities.grantCapability (grantor, recipient, cap);
    }

	/**
	 * This is a convenience method, principally for using the constants
	 * in {@link SecurityCapability} like
	...
	public static boolean hasCapability (final AbstractUser who,
		...
		return Security.hasCapability (who, SQLPeerEnum.get (
				SecurityCapability.class, capabilityID.intValue ()));
	}
	 ...
	 */
    public synchronized static boolean hasCapability (final AbstractUser who,
        ...
        || Security.capabilities.forUser (who).contains (
