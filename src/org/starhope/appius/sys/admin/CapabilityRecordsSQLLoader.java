...
public class CapabilityRecordsSQLLoader implements
	...
	public void changed (final CapabilityRecords changedRecord) {
		...
		BugReporter
				.getReporter ("srv")
				.reportBug (
						"unimplemented CapabilityRecordsSQLLoader::changed (brpocock@star-hope.org, Jun 7, 2010)");
	}
	...
	public String getSubversionRevision () {
		...
		BugReporter
				.getReporter ("srv")
				.reportBug (
						"unimplemented CapabilityRecordsSQLLoader::getSubversionRevision (brpocock@star-hope.org, Jun 7, 2010)");
		return null;
	}
	...
	public synchronized CapabilityRecords loadRecord (final int id)
		...
		try {
			...
			st = con.prepareStatement ("SELECT userID, capabilityID FROM userCapabilities");
			rs = st.executeQuery ();
			final CapabilityRecords rec = new CapabilityRecords (
					this);
			while (rs.next ()) {
				rec.addCapability (
						Nomenclator.getUserByID (rs
								.getInt ("userID")),
						new SecurityCapability (rs
								.getInt ("capabilityID")));
			}
			rec.markAsLoaded ();
			return rec;
	...
	@Override
	public void refresh (final CapabilityRecords record) {
	...
	public void removeRecord (final CapabilityRecords record) {
		...
		BugReporter
				.getReporter ("srv")
				.reportBug (
						"unimplemented RecordLoader<CapabilityRecords>::removeRecord (brpocock@star-hope.org, Jul 22, 2010)");
	...
	public void saveRecord (final CapabilityRecords record) {
		...
		BugReporter
				.getReporter ("srv")
				.reportBug (
						"unimplemented CapabilityRecordsSQLLoader::saveRecord (brpocock@star-hope.org, Jun 7, 2010)");
