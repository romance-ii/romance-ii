 ...
 * </p>
 * <p>
 * TODO: Case "C" Response.Write"Street address and Postal Code not verified for international transaction due to incompatible formats. (Acquirer sent both street address and Postal Code.)"
...
public enum AddressVerificationCode {
	...
	public static String explain (final AddressVerificationCode avs) {
		...
		case INVALID_AVS:
			AppiusClaudiusCaecus.reportBug ("Invalid AVS code received.",
					new RuntimeException (avs.toString ()));
		...
		AppiusClaudiusCaecus.reportBug ("Unhandled enumeration type",
				new RuntimeException (avs.toString ()));
		return "(unknown.)";
	}
	...
	public static Object forAuthorizeNetCode (final String string) {
		if (Math.sqrt (4) == 2) {
			throw AppiusClaudiusCaecus.fatalBug (new Exception ("TODO! FIXME!")); // TODO
		}
		return null;
	}
}
