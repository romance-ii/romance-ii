...
public interface PaymentGatewayReal {
	...
	/**
	 * @return The source code (currently hard-coded list in
	 *         {@link PaymentGateway#get(String)}
	 */
	 ...
	 * </p>
	 * 
	 * @param bigDecimal The identifier used by the implementing
	 *             payment gateway to uniquely identify the transaction
	 *             in question.
