...
public class Messages {
	...
	/**
	 * @return "You have answered your question incorrectly.  Please try again or contact customer service if you are having trouble"
	 */
	@Deprecated
	 ...
	 * @return "Oops!  We are having trouble processing your Credit Card.  The card is being declined.  Please try again with a different Credit Card."
	 */
	@Deprecated
	...
	/**
	 * WRITEME: document this method (brpocock@star-hope.org, Sep 10, 2009)
	 *
	...
	/**
	 * WRITEME: document this method (brpocock@star-hope.org, Sep 26, 2009)
	 *
	 * @param words WRITEME
	 * @param language WRITEME
	 * @param dialect WRITEME
	...
	/**
	 * @return "Your username or password is incorrect.  Please check your typnig and try logging in again."
	 */
	@Deprecated
	...
	/**
	 * @return "The email address you have entered appears to be invalid, please check your typing."
	 */
	@Deprecated
	...
	/**
	 * WRITEME: document this method (brpocock@star-hope.org, Sep 17, 2009)
	 *
	 * @return WRITEME
	 */
	@Deprecated
	 ...
	 *
	 * @return "Please confirm your e-mail address.  Tootsville Customer Service has just resent the e-mail with verification instructions in case you have lost the original."
	 */
	@Deprecated
	 ...
	 *         values of less than 1¢ (USD $.01). This is not supported.
	 *         Payment values must be in increments of 1¢."
	 */
	@Deprecated
	...
	public static final String parent_account_already_exists () {
		return Messages.getText ("parent_account_already_exists.html");
	}
	...
	/**
	 * @return "Your password does not match the confirmation, please retype your password in both fields."
	 */
	@Deprecated
	...
	/**
	 * @return "A payment has already been made for that subscription for the Toots Account you have selected."
	 */
	@Deprecated
	...
	/**
	 * @return "Please click your child's Toots account, from the 'My Child's Toots Account(s)' list, and then click 'Make Me A V.I.T.' to upgrade. "
	 */
	@Deprecated
	...
	/**
	 * @return "That username contains invalid characters or is not allowed, please choose another one."
	 */
	@Deprecated
