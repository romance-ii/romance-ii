...
public class EnrolmentSQLLoader implements RecordLoader <Enrolment> {
	...
	public void changed (final Enrolment changedRecord) {
		...
		AppiusClaudiusCaecus
				.reportBug ("unimplemented RecordLoader<Enrolment>::changed (brpocock@star-hope.org, Jul 23, 2010)");
	}
	...
	public boolean isRealtime () {
		// TODO Auto-generated method stub brpocock@star-hope.org
		AppiusClaudiusCaecus
				.reportBug ("unimplemented RecordLoader<Enrolment>::isRealtime (brpocock@star-hope.org, Jul 23, 2010)");
		return false;
	}
	 ...
	 */
	@Override
	public Enrolment loadRecord (final int id) throws NotFoundException {
		Connection con = null;
	...
	public void removeRecord (final Enrolment record) {
		// TODO Auto-generated method stub brpocock@star-hope.org
		AppiusClaudiusCaecus
				.reportBug ("unimplemented RecordLoader<Enrolment>::removeRecord (brpocock@star-hope.org, Jul 23, 2010)");
	...
	public void saveRecord (final Enrolment record) {
		// TODO Auto-generated method stub brpocock@star-hope.org
		AppiusClaudiusCaecus
				.reportBug ("unimplemented RecordLoader<Enrolment>::saveRecord (brpocock@star-hope.org, Jul 23, 2010)");
	...
	protected Enrolment set (final ResultSet rs) throws SQLException {
		...
		enrolment
				.setAvailable ("Y".equals (rs.getString ("available")));
