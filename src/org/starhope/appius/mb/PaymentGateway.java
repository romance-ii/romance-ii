...
import org.starhope.appius.pay.PayPalGateway;
...
PaymentGatewayReal {
	...
	public static Class <? extends PaymentGatewayReal> get (
		...
		} else if ("ppal".equals (id)) {
			return PayPalGateway.class;
	...
	private PaymentGatewayReal getImplementation () throws Exception {
		if (implementation == null) {
			try {
				implementation = (PaymentGatewayReal) Class.forName (
						implementor).newInstance ();
	...
	public String getOrderSourceCode () {
		return null == implementation ? null : implementation.getOrderSourceCode ();
	}
	...
	/**
	 * @param implementor1 Set the actual Payment Gateway implementation
	 *        to be used (String)
	 */
