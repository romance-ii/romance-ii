...
public class Toasts extends Nothing {
	...
	public int doStartTag () throws JspException {
		...
		try {
			...
			Toasts.log.error (
					"Caught a IOException in Toasts.doStartTag ",
					e);
		}
	 ...
	 * 
	 * @param out WRITEME  brpocock 
	 * @param session WRITEME  brpocock 
	 * @param fieldsHere WRITEME  brpocock 
	 * @throws IOException
	 */
	private void printErrorToasts (final JspWriter out,
			final MBSession session,
			final Set <MBFieldIdent> fieldsHere) throws IOException {
