...
// public com.google.gwt.dom.client.Element getEditHTML (
	...
	/**
	 * Set the value, only if it passes {@link #checkValue(Object)} test
	 * for validity.
	 * 
	 ...
	 * thrown in an attempt to convert the input into the local type <T>
	 * 
	...
	public T setValueConverted (final Object newValue){
		try {
			...
			AppiusClaudiusCaecus.blather ("Input error: "
					+ ident.toString () + " " + e.getMessage ());
			return value;
		}
	}
	 ...
	 * page context given.
	 * 
	 * @param context the {@link PageContext} of the servlet, into which
	 *            to write.
