...
public class UserNotifier {
	 ...
	 * @return WRITEME
	 */
	public static NotificationSet getNotificationsTo (final AbstractUser whom) {
	 ...
	 * @return WRITEME
	 */
	public static NotificationSet getUnreadNotificationsTo (final AbstractUser whom) {
		UserNotifier.initStorage ();
	...
	private static synchronized void initStorage () {
		...
		UserNotifier.storage= (NotificationSetLoader) AppiusConfig.getRecordSetLoaderForClass (NotificationSet.class);
	}
}
