...
public class AvatarBodyFormat extends
	...
	/**
	 * Determine whether avatars using this body format are permitted to
	 * equip items of the given type. This is a veto authority, not an
	 * assertion of privilege: there could still be another reason why a
	 * particular user might not be permitted to equip the item. This,
	 * however, might e.g. prevent a dog from wearing human shoes.
	 * 
