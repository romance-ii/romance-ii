...
public class ActionHandler implements ActionHandlerInterface {
	 ...
	 * @param dative indirect object explaining more about what
	 *             happened
	...
	public boolean invoke (final Action action) {
		return myTarget.acceptAction (action.getWhere (),
				action.getSubject (), action.getVerb (),
				action.getObject (), action.getIndirectObject (),
				action.getTrailer ());
	}
