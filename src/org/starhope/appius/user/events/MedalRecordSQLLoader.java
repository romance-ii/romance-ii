...
public class MedalRecordSQLLoader extends MedalRecordLoader {
    ...
    public void changed (final MedalRecord changedRecord) {
        ...
        .reportBug ("Unimplemented: MedalRecordSQLLoader.changed called with "
	...
	public void removeRecord (final MedalRecord record) {
		...
		AppiusClaudiusCaecus.reportBug("unimplemented RecordLoader<MedalRecord>::removeRecord (brpocock@star-hope.org, Jul 22, 2010)");
    ...
    public void saveRecord (final MedalRecord record) {
        // XXX
        AppiusClaudiusCaecus
        .reportBug ("Unimplemented: MedalRecordSQLLoader.saveRecord called with "
                + record.toString ());
    }

    @Override
    public void refresh (MedalRecord record) {
