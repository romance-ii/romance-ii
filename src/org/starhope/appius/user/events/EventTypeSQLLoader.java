...
public class EventTypeSQLLoader implements RecordLoader <EventType> {
	...
	protected EventType getEventType (final ResultSet set)
			throws SQLException {
		final EventType eventType = new EventType (this);
	 ...
	 */
	@Override
	public EventType loadRecord (final int id)
	...
	public void removeRecord (final EventType record) {
		BugReporter
				.getReporter ("srv")
				.reportBug (
						"unimplemented EventTypeSQLLoader::removeRecord (brpocock@star-hope.org, Jul 23, 2010)");
	...
	public void saveRecord (final EventType record) {
		...
		try {
			...
			final long frequencyPeriod = record
					.getFrequencyPeriod ();
