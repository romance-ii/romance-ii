...
public class Action {
	 ...
	 */
	public Action (final Room newWhere, final AbstractUser newSubject,
			final String newVerb, final Object... newTrailer) {
		where = newWhere;
		subject = newSubject;
		verb = newVerb;
		trailer = newTrailer;
	...
	public String toString () {
		...
		s.append ( (null == where ? "Ø" : where.getDebugName ()));
		s.append (" | ");
		s.append ( (null == subject ? "Ø" : subject.getDebugName ()));
		s.append (" | ");
