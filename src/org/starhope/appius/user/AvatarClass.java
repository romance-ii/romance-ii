...
import org.starhope.appius.geometry.PolygonBuilder;
import org.starhope.appius.geometry.PolygonPrimitive;
import org.starhope.appius.net.datagram.ADPAvatar;
...
implements CastsToJSON {
	...
	/**
	 * The base movement speed for this avatar
	 */
	private int baseSpeed = 128;
	...
	public boolean equals (final Object obj) {
		...
		if ( ! (obj instanceof AvatarClass)) {
			return false;
		}
		final AvatarClass other = (AvatarClass) obj;
		if (id != other.id) {
			return false;
		}
		return true;
	...
	public PolygonPrimitive <?> getCollisionBounds () {
		return null == collisionBounds ? (collisionBounds = PolygonBuilder
				.instanceOf (collisionBoundsString))
				: collisionBounds;
	}
	 ...
	 * @return WRITEME 
	 */
	public ADPAvatar getDatagram (final ChannelListener s) {
		final ADPAvatar result = new ADPAvatar (s);
		result.setFileName (filename);
		result.setFormat (getBodyFormat ());
		return result;
	}
	...
	/**
	 * @return the default extra colour associated with the avatar
	 *         class
	 */
	...
	public Colour getDefaultExtraColour () {
		 ...
		 */
		public void setBaseSpeed (final int baseSpeed) {
		...
		public void setDefaultPattern (
				final GenericItemReference newPattern) {
