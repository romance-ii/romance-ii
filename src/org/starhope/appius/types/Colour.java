...
public class Colour implements Serializable {
	...
	private static final Logger log = LoggerFactory
			.getLogger (Colour.class);
	
	/**
	 * Serial Version UID serialVersionUID (long)
	 */
	 ...
	 * blue components. To get a compatible value, you can call
	 * 
	 * @see{toLong
	 ...
	 * </p>
	 * <ul>
	 * <li>The "CSS style" uses a decimal triplet in the form
	 * rgb(R,G,B) (the literal string "rgb(" identifies it).</li>
	 ...
	 * {r:255} or #f or rgb(255) is identical to #f00 or rgb(255,0,0)
	 * or {r:255,g:0,b:0}.
	 * </p>
	...
	public Colour (final String rgb) throws NumberFormatException,
		...
		if (html6Matcher.matches ()) {
			...
			blue = Short.parseShort (html6Matcher.group (3), 16);
			return;
		}
	...
	public Colour add (final int reddenning, final int greening,
			final int bluing) throws DataException {
		return new Colour (Math.min (reddenning + red, 0xff),
				Math.min (greening + green, 0xff), Math.min (bluing
						+ blue, 0xff));
	}
	...
	/**
	 * @return a 24-bit value (in a integer) representing the combined
	 *         red, green, and blue values, one byte per each.
	 */
	public int toInt () {
