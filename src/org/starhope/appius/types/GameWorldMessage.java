...
public interface GameWorldMessage {
	...
	/**
	 * Return a representation of this object in JSON form. Identical
	 * to calling {@link #toJSON(boolean)} with inMailbox set to
	 * “false”
	 * 
	 * @return WRITEME
	 ...
	 * </p>
	 * <p>
	 * <strong>Note</strong> that this will <em>not</em> undelete a
	 * Wall message correctly, as it will go into the Inbox regardless.
	 * </p>
	 */
