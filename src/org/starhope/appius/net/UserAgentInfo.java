...
public class UserAgentInfo implements Serializable {
	...
	/**
	 * @return whether the client can click with modifiers like Shift or
	 *         so forth. Absent on touchscreens and similar devices,
	 *         typically.
	 */
	 ...
	 * the contents</li>
	 * <li>If the length is equal to or greater than 255 bytes, then the
	 * magic value x'ff' is sent, followed by the 64-bit length
	 ...
	 *            which is not mandatory for all user-agents to support)
	 */
	 ...
	 * “nintendo_ds,” “nintendo_dsi,” “nintendo_3ds.” Note that the word
	 * “Nintendo” is part of the name of the DS/DSi/3DS, but
	 ...
	 *            can be accessed <em>without</em> operating an overlay
	 *            (not a touchscreen or similar text-entry mechanism)
	 */
	 ...
	 * </p>
	 * <ul>
	 * <li>Support for three mouse buttons (button 1, 2, 3) or analogues
	 * </li>
	 ...
	 *            world) that the user-agent can display simultaneously
	 */
