...
public class WebSocketProcessor extends StreamProcessor {
	...
	protected void dropSocket_socketCore () {
		AppiusClaudiusCaecus
				.reportBug ("unimplemented WebSocketProcessor::dropSocket_socketCore (brpocock@star-hope.org, Sep 15, 2010)");
	}
	...
	protected synchronized void dropSocketConnection () {
		try {
			...
			AppiusClaudiusCaecus
					.reportBug (
							"Caught a IOException in WebSocketProcessor.dropSocketConnection ",
							e);
		}
	}
	...
	protected String grabInput () throws UserDeadException {
		try {
			...
			AppiusClaudiusCaecus
					.reportBug (
							"Caught a IOException in WebSocketProcessor.grabInput ",
							e);
			return null;
		}
	}
