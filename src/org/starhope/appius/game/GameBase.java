 ...
 * @author brpocock@star-hope.org Bruce-Robert Pocock
 */
public abstract class GameBase implements AcceptsMetronomeTicks {
	 ...
	 */
	protected final ConcurrentHashMap <AbstractUser, Long> scores = new ConcurrentHashMap <AbstractUser, Long> ();
	 ...
	 */
	protected GameBase (final Zone z, final String moniker) {
	 ...
	 */
	public boolean equals (final GameBase other) {
		return this == other;
	}
	...
	public boolean equals (final Object other) {
		if (other instanceof GameBase) {
			return this.equals ((GameBase) other);
		}
		return false;
	}
	 ...
	 * This is an overriding method.
	 * 
	 * @see org.starhope.appius.game.rooms.RoomListener#getZone()
	 */
	public Zone getZone () {
		return zone;
	}
