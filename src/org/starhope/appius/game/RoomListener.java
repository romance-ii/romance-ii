...
public interface RoomListener extends ChannelListener {
	...
	/**
	 * Accept an out-of-band communications packet that was broadcast
	 * to a room in which this Listener is listening.
	 * 
	...
	/**
	 * Accept a public chat message. This prototype does not specify
	 * the room, on the (potentially invalid) assumption that the room
