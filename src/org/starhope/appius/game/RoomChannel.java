...
public class RoomChannel extends Channel {
	 ...
	 */
	public void broadcastAcceptUserVariableUpdate (final AbstractUser user,
	 ...
	 *
	 * @param listener WRITEME ewinkelman
	 * @param suppressBroadcast WRITEME ewinkelman
	 * @return WRITEME ewinkelman
	 */
	public boolean join (final RoomListener listener,
