...
/**
 * <p>
 * The Plebeian class is a base class for simply scripted NPC:s using
 * the Plebeian structure, which is meant to be a fairly understandable
...
public class Plebeian extends AbstractNonPlayerCharacter implements
	...
	public void acceptErrorReply (final String command,
		...
		scriptRunner.dispatch (new Action (userCurrentRoomInZone,
				this, command + ".err", error));
	}
	...
	public void acceptPrivateMessage (final AbstractUser speaker,
			final String speech) {
		scriptRunner
				.dispatch (new Action (speaker, "whisper", speech));
	}
	...
	public void acceptSuccessReply (final String command,
		...
		scriptRunner.dispatch (new Action (room, this, command
				+ ".ok", jsonData));
	}
