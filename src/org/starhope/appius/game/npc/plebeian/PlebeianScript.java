...
public class PlebeianScript {
	 ...
	 * Used by e.g. “If” clauses. The steps will be prepended in reverse
	 * order so as to retain their original sequence.
	 * 
	 * @param pleb TODO
	 */
	protected void nowRun (final ScriptPuppet pleb) {
		final List <Runnable> steps = new LinkedList <Runnable> (getSteps ());
