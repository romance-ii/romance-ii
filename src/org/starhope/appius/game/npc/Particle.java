...
public class Particle extends Ejecta {
	 ...
	 */
	public void fire (final Room room,
            final Coord3D origin, final long birth,
            final Coord3D target, final double travelRate, final long duration) {
		super.fire (room, origin, birth, target, travelRate);
        final Particle particle = this;
        AppiusClaudiusCaecus.getKalendor ().schedule (birth + duration,
                new ParticleDestroyer (particle));
    }
