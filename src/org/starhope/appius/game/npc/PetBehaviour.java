...
public enum PetBehaviour {
	/**
	 * Set this pet to follow a random person in the room BOTHER_FRIEND
	 * (PetBehaviour)
	 */
	BOTHER_FRIEND,
	 ...
	 * “train” like a Conga Line. FOLLOW_LEADER (PetBehaviour)
	 */
	FOLLOW_LEADER,
	/**
	 * Follow the master (owner). This will create a sort of flock
	 * around the owner if many pets choose it. FOLLOW_MASTER
	 * (PetBehaviour)
	 */
	FOLLOW_MASTER,
	/**
	 * When the master leaves the screen, hurry to their last-known
	 * position and then vanish ourself. MASTER_EXIT (PetBehaviour)
	 */
	MASTER_EXIT,
	/**
