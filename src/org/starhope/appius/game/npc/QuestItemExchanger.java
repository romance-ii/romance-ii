...
public abstract class QuestItemExchanger extends
	 ...
	 * WRITEME
	 */
	protected final Map <GenericItemReference, GenericItemReference> itemExchanges = new ConcurrentHashMap <GenericItemReference, GenericItemReference> ();
	/**
	 * WRITEME
	 */
	protected final Map <GenericItemReference, GenericItemReference> itemFollowUps = new ConcurrentHashMap <GenericItemReference, GenericItemReference> ();
	/**
	 * WRITEME
	 */
	protected final Map <GenericItemReference, Runnable> itemReactions = new ConcurrentHashMap <GenericItemReference, Runnable> ();
	
	/**
	 * WRITEME
	 */
	protected final Map <Pattern, String> speechReactions = new ConcurrentHashMap <Pattern, String> ();
	 ...
	 *              something like that
	 * @throws NotFoundException if the login can't be found, or
	 *              similar
	 */
