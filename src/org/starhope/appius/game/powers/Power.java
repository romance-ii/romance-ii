...
/**
 * Base interface for anything that implements a "power"
 *
 * @author ewinkelman@resinteractive.com Ed Winkelman
 * @author twheys@gmail.com Timothy W. Heys
 * @author brpocock@star-hope.org Bruce-Robert Pocock
...
public interface Power {
	...
	interface Factory {
		 ...
		 * @param info WRITEME 
		 * @param pc WRITEME 
		 * @param saveInfo WRITEME 
		 * @return WRITEME 
		 */
		Power create (PowerItemInfo info);
	}

	/**
	 * Gets an ID that uniquely identifies this instance of a power
	 *
	 * @return WRITEME 
	 */
	int getID();
