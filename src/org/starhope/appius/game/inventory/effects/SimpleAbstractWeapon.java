...
public class SimpleAbstractWeapon extends ItemEffects {
     ...
     */
    public SimpleAbstractWeapon (final InventoryItem theItem) {
        super (theItem);
    }
    ...
    /**
     * Whenever a shot is fired, or the weapon is reloaded, this hook is called to give subclasses an
     * opportunity to save the changed value, usually as the item's health value.
     */
     ...
     */
    public void setHitHandler (final DamageHitHandler newHitHandler) {
     ...
     */
    public void setLimitedAmmunition (final boolean newLimitedAmmunition) {
     ...
     */
    public void setMissHandler (final DamageMissHandler newMissHandler) {
