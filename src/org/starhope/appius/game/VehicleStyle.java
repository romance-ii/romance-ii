...
public class VehicleStyle implements Serializable {
	 ...
	 */
	public static final VehicleStyle ANY = new VehicleStyle (true,true,true,false);
	/**
	 * All vehicles are only allowed, but only allowed in the $drive space in the room.
	 */
	public static final VehicleStyle DRIVE_ON_DRIVE = new VehicleStyle (true,true,true,true
			);
	/**
	 * No vehicles are permitted, at all. Note that there is an
	 * exceptional case available for specific vehicles that might
	 * occupy a vehicle slot, but not be considered as vehicles, e.g. in
	 * Tootsville the Lightfield is equipped as a vehicle. Wheelchairs
	 * or similar might likewise be exempted.
	 */
	public static final VehicleStyle NO_VEHICLES = new VehicleStyle (false, false, false, false);
	/**
	 * WRITEME: Document this constructor brpocock@star-hope.org
	 *
	 * @param allowWheeled allow wheeled, dragged, and similar objects
	 * @param allowMounted allow mounts such as horses, dogs, dragons, whatever
	 * @param allowFloating allow floating vehicles
	 * @param driveOnDrive limit vehicles to only the driveway
	 */
	public VehicleStyle (final boolean allowWheeled, final boolean allowMounted, final boolean allowFloating, final boolean driveOnDrive) {
