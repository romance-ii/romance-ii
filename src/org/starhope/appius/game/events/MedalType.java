...
public class MedalType extends SQLPeerEnum {
	 ...
	 * Logging
	 */
	private static final Logger log = LoggerFactory.getLogger (MedalType.class);
	 ...
	 */
	@Override
	protected PreparedStatement getStatement (final Connection connection) throws SQLException {
			return connection
