...
/**
 * A collection of damage (or attack, or defense) values. This
...
public class DamageTypeRanks implements Serializable {
	...
	public DamageTypeRanks add (final DamageTypeRanks other) {
		if (null == other) {
			AppiusClaudiusCaecus
					.reportBug ("Not adding null to DamageTypeRanks");
			return this;
		}
	...
	/**
	 * invert the sign (positive/negative) of every score in this
	 * object.
	 */
	...
	public void multiply (final DamageTypeRanks other) {
		if (null == other) {
			AppiusClaudiusCaecus
					.reportBug ("Can't multiple damage ranks by null");
			return;
		}
		for (final DamageArea area : other.keySet ()) {
	...
	public String toString () {
		...
		for (Map.Entry <DamageArea, Double> score : scores.entrySet ()) {
