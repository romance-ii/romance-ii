...
public class GameVar extends SimpleDataRecord <GameVar> implements
	 ...
	 */
	public GameVar (final RecordLoader <? super GameVar> loader) {
		super (loader);
	}
	...
	public boolean equals (final Object obj) {
		...
		if ( ! (obj instanceof GameVar)) {
			return false;
		}
		final GameVar other = (GameVar) obj;
		if (klass == null) {
			if (other.klass != null) {
				return false;
			}
