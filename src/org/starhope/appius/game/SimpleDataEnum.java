...
public abstract class SimpleDataEnum <T extends SimpleDataEnum <?>>
	 ...
	 * 
	 * @param subclass WRITEME  brpocock 
	 */
	...
	public boolean equals (final Object aObj) {
		...
		BugReporter
				.getReporter ("srv")
				.reportBug (
						"Unimplemented method equals in SimpleDataEnum, added Jan 31, 2012 by brpocock. TODO.");
		return false;
	}
	...
	public int hashCode () {
		...
		BugReporter
				.getReporter ("srv")
				.reportBug (
						"Unimplemented method hashCode in SimpleDataEnum, added Jan 31, 2012 by brpocock. TODO.");
		return 0;
	}
