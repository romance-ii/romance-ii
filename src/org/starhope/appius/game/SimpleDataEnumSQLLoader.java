...
public abstract class SimpleDataEnumSQLLoader <T extends SimpleDataEnum <?>, L extends SimpleDataEnumSQLLoader <T, ?>>
	...
	private static final Logger log = LoggerFactory
			.getLogger (SimpleDataEnumSQLLoader.class);
	...
	protected SimpleDataEnumSQLLoader (final String theTableName,
			final String theIDColumnName,
			final String theNameColumnName) {
	 ...
	 * @throws NotFoundException if the class can't be loaded or
	 *              doesn't have
	 */
	private T getRecordObject () throws NotFoundException {
		...
		try {
			...
			SimpleDataEnumSQLLoader.log
					.error ("Can't instantiate record ("
							+ getRecordClass ()
									.getCanonicalName ()
	 ...
	 */
	private void loadRecord (final T o, final ResultSet rs)
			throws SQLException {
		rs.next ();
	...
	public void refresh (final T record) {
		...
		try {
			...
			SimpleDataEnumSQLLoader.log
					.error ("Caught a SQLException in SimpleDataEnumSQLLoader.refresh ",
							e);
		} finally {
			LibMisc.closeAll (rs, st, con);
		}
