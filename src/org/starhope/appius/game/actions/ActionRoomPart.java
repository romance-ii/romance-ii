 ...
 * @author ewinkelman@resinteractive.com Ed Winkelman
 */
public class ActionRoomPart extends ActionObject <Room> {
	 ...
	 * 
	 * @param room WRITEME 
	 * @param theUserLeaving WRITEME 
	 */
	public ActionRoomPart (final Room room,
			final AbstractUser theUserLeaving) {
		super (room);
		user = theUserLeaving;
	}
