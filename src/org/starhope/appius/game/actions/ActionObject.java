...
public abstract class ActionObject <T> {
	 ...
	 */
	private static final long serialVersionUID = -1738241794445780495L;
	...
	/**
	 * Creates an action with the given source
	 * 
	 * @param thisSource WRITEME 
	 */
	public ActionObject (final T thisSource) {
