...
public class LinearMotionTween implements MotionTween {
    ...
    /**
	 * @throws NotImplementedException because it isn't
    ...
    /**
     * @see org.starhope.appius.things.tween.MotionTween#getMotionLineForTimeInterval(long, long)
     */
    @Override
    public LineSeg3D getMotionLineForTimeInterval (final long startTime,
            final long endTime)
    {
        // TODO Auto-generated method stub brpocock@star-hope.org
        AppiusClaudiusCaecus
                .reportBug ("unimplemented LinearMotionTween::getMotionLineForTimeInterval (brpocock@star-hope.org, Oct 5, 2010)");
        return null;
    }
