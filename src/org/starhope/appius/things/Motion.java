...
public class Motion {
	 ...
	 * WRITEME
	 */
	private MotionTween motionTween = MotionTweenFactory
			.getLinear (this);
	 ...
	 */
	public void setEndTime (final long newEndTime) {
		endTime = newEndTime; /* TODO brpocock@star-hope.org */
	}
	
	/**
	 * @param newTween the motionTween to set
	 */
	public void setMotionTween (final MotionTween newTween) {
		motionTween = newTween; /* TODO brpocock@star-hope.org */
	}
