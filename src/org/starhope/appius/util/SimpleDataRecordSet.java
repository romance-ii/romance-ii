/**
 * <h1>SimpleDataRecordSet.java (org.starhope.appius.util)</h1> <h2>
 * Project: Romance</h2>
 * <p>
...
public abstract class SimpleDataRecordSet <DataRecordClass extends DataRecord, DataRecordSetClass extends SimpleDataRecordSet <DataRecordClass, DataRecordSetClass>>
	...
	public boolean add (final DataRecordClass o) {
		...
		try {
			prior = map.put (Integer.valueOf (o.getCacheableID ()),
					o);
		} catch (final NotFoundException e) {
			throw new NumberFormatException (
					o.getClass ()
							+ " returned NotFoundException, violating contract");
		}
	...
	public boolean equals (final Object aObj) {
		...
		BugReporter
				.getReporter ("srv")
				.reportBug (
						"Unimplemented method equals in SimpleDataRecordSet, added Jan 31, 2012 by brpocock. TODO.");
		return false;
	}
	...
	public int hashCode () {
		...
		BugReporter
				.getReporter ("srv")
				.reportBug (
						"Unimplemented method hashCode in SimpleDataRecordSet, added Jan 31, 2012 by brpocock. TODO.");
		return 0;
	}
	 ...
	 *      call this method. Thus, any changes to this routine may
	...
	public boolean remove (final Object o) {
		...
		for (final Entry <Integer, DataRecordClass> e : map
				.entrySet ()) {
	 ...
	 *      Note that this implementation, for efficiency, does not
	 *      call {@link #remove(Object)}
	 *      </p>
	 */
	@Override
