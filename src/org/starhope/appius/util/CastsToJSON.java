...
public interface CastsToJSON extends Serializable {
     ...
     * JSONObject
     * 
     * public JSONObject(java.lang.Object bean, boolean
     * includeSuperClass)
     * 
     * Construct JSONObject from the given bean. This will also create
     * JSONObject for all internal object (List, Map, Inner Objects) of
     * the provided bean. -- See Documentation of JSONObject(Object
     * bean) also.
     * 
     * Parameters: bean - An object that has getter methods that should
     * be used to make a JSONObject. includeSuperClass - - Tell whether
     * to include the super class properties.
     */
