...
public class JSONUtil {
	 ...
	 */
	public static Date toDate (final JSONObject o) throws JSONException {
	...
	/**
	 * This is an utility method to convert a Time value (java.sql.Time)
	 * into a JSONObject.
	 * 
	 * Implementation note: We just store the Unix time (seconds since
	 * the epoch of 1970-01-01 00:00:00 UCT/GMT) in a single field. The
	 * broken-down date and time values are not included.
	 * 
