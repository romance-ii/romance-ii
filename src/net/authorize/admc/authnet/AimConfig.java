...
public class AimConfig {
	/**
	 * WRITEME: document this field (brpocock@star-hope.org, Nov 13,
	 * 2009) login (AimConfig)
	 */
	private String login = null;
	/**
	 * WRITEME: document this field (brpocock@star-hope.org, Nov 13,
	 * 2009) md5Kernel (AimConfig)
	 */
	private String md5Kernel = null;
	/**
	 * WRITEME: document this field (brpocock@star-hope.org, Nov 13,
	 * 2009) pdelimiter (AimConfig)
	 */
	private char pdelimiter = '\0';
	/**
	 * WRITEME: document this field (brpocock@star-hope.org, Nov 13,
	 * 2009) pencap (AimConfig)
	 */
	private char pencap = '\0';
	/**
	 * WRITEME: document this field (brpocock@star-hope.org, Nov 13,
	 * 2009) pminfields (AimConfig)
	 */
	private int pminfields = -1;
	/**
	 * WRITEME: document this field (brpocock@star-hope.org, Nov 13,
	 * 2009) prelay_response (AimConfig)
	 */
	private String prelay_response = null;
	/**
	 * WRITEME: document this field (brpocock@star-hope.org, Nov 13,
	 * 2009) pversion (AimConfig)
	 */
	private String pversion = null;
	/**
	 * WRITEME: document this field (brpocock@star-hope.org, Nov 13,
	 * 2009) requireCardCode (AimConfig)
	 */
	private boolean requireCardCode = false;
	/**
	 * WRITEME: document this field (brpocock@star-hope.org, Nov 13,
	 * 2009) testMode (AimConfig)
	 */
	private boolean testMode = false;
	/**
	 * WRITEME: document this field (brpocock@star-hope.org, Nov 13,
	 * 2009) tran_key (AimConfig)
	 */
	 ...
	 * <p>
	 * We purposefully keep no handle to the new transactions. When
	 * user finishes with them, the JVM should GC them.
	 * </p>
	 * 
	 * @return WRITEME
	 */
