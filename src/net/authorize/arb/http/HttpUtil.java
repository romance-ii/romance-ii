...
public class HttpUtil {
	...
	private String getHttpSocket (final String thatHost,
		...
		try {
			...
			HttpUtil.log
					.error ("Caught an UnknownHostException in HttpUtil.getHttpSocket ",
							e);
		} catch (final IOException e) {
			HttpUtil.log
					.error ("Caught an IOException in HttpUtil.getHttpSocket ",
							e);
		} catch (final Exception e) {
			HttpUtil.log
					.error ("Caught an unexpectedException in HttpUtil.getHttpSocket ",
							e);
		} finally {
			try {
				if (null != socket) {
				...
				HttpUtil.log.error ("IOException", e);
			}
		}
		return null;
	}
	...
	private String getSecureHttpSocket (final String password,
		...
		try {
			...
			final SSLSocketFactory factory = context
					.getSocketFactory ();
			final SSLSocket socket = (SSLSocket) factory
					.createSocket (host, HttpUtil.HTTPS_PORT);
			socket.setSoTimeout (10000);
			...
			HttpUtil.log.error ("SSLException", e);
		} catch (final NoSuchAlgorithmException e) {
			HttpUtil.log
					.error ("Caught a NoSuchAlgorithmException in HttpUtil.getSecureHttpSocket ",
							e);
		} catch (final KeyStoreException e) {
			HttpUtil.log
					.error ("Caught a KeyStoreException in HttpUtil.getSecureHttpSocket ",
							e);
		} catch (final KeyManagementException e) {
			HttpUtil.log
					.error ("Caught a KeyManagementException in HttpUtil.getSecureHttpSocket ",
							e);
		} catch (final UnknownHostException e) {
			HttpUtil.log
					.error ("Caught an UnknownHostException in HttpUtil.getSecureHttpSocket ",
							e);
		} catch (final IOException e) {
			HttpUtil.log
					.error ("Caught an IOException in HttpUtil.getSecureHttpSocket ",
							e);
		}
		return null;
	}
	...
	public boolean initializeKeyStore (final String password,
		...
		try {
			...
			HttpUtil.log
					.error ("Caught a KeyStoreException in HttpUtil.initializeKeyStore ",
							e);
		} catch (final NoSuchAlgorithmException e) {
			HttpUtil.log
					.error ("Caught a NoSuchAlgorithmException in HttpUtil.initializeKeyStore ",
							e);
		} catch (final CertificateException e) {
			HttpUtil.log
					.error ("Caught a CertificateException in HttpUtil.initializeKeyStore ",
							e);
		} catch (final IOException e) {
			HttpUtil.log
					.error ("Caught a IOException in HttpUtil.initializeKeyStore ",
							e);
		} catch (final KeyManagementException e) {
			HttpUtil.log
					.error ("Caught a KeyManagementException in HttpUtil.initializeKeyStore ",
							e);
		} finally {
			if (null != out) {
				try {
